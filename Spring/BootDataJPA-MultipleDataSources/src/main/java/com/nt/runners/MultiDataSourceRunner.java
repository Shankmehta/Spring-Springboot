...
public class MultiDataSourceRunner implements CommandLineRunner 
{
   ...
   private IOffersRepo offersRepo;
	...
	public void run(String... args) throws Exception {
        ...
        offersRepo.saveAll(Arrays.asList(new Offers("Buy-1-Get-1","B1G1",100.0,LocalDateTime.of(2024, 11,20,10,11)),
        		new Offers("Buy-1-Get-2","B1G2",200.0,LocalDateTime.of(2024, 11,20,10,11)),
        		new Offers("Buy-2-Get-2","B2G2",100.0,LocalDateTime.of(2024, 11,20,10,11))
        		));
        System.out.println("offers are saved");
        System.out.println("=====================");
        System.out.println("=======display record (product)=====");
